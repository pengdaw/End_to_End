...
class SegDeformableTransformer(Transformer):
    ...
    def forward(self,
        ...
        memory = self.encoder(query=feat_flatten,
                              key=None,
                              value=None,
                              query_pos=lvl_pos_embed_flatten.to(dtype=feat_flatten.dtype),
                              query_key_padding_mask=mask_flatten,
                              spatial_shapes=spatial_shapes,
                              reference_points=reference_points.to(dtype=feat_flatten.dtype),
                              level_start_index=level_start_index,
                              valid_ratios=valid_ratios.to(dtype=feat_flatten.dtype),
                              **kwargs)
